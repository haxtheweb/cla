...
1. **Open a Pull Request**: When you submit your first pull request on a project repository, the CLA bot will automatically post a comment asking you to sign the CLA.
...
**Questions?** Feel free to open an [issue](https://github.com/haxtheweb/issues) or ask in your pull request if you need help with the CLA process.